...
class CharacterStage {
        ...
        if (lipAnim) {
            ...
            if (voiceObj && typeof voiceObj.once === 'function') {
                ...
                const timer = setTimeout(() => {
                    this._lipTimers.delete(timer);
                    this.stopLipAnimation(label);
                }, lipAnimDuration * 1000 + 200);
                this._lipTimers.add(timer);
            }
        }
    ...
    reset() {
        this._lipTimers.forEach(timer => clearTimeout(timer));
        this._lipTimers.clear();
